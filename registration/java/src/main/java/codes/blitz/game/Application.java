...
import codes.blitz.game.algos.OverheadLinearSolution;
  ...
  */
  ...
  public static void main (String [] args) {
    ...
    app.post("/microchallenge", ctx -> {
      ...
      RailTransportProblem algorithm = new OverheadLinearSolution();

      List<Integer> output = algorithm.execute(tracks, items);
      ctx.json(output);
    });
  }
}
